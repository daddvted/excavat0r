...
class HousingEnsuringProjSpider(object):
    ...
    def crawl(self):
        for p in range(1, 8):
            ...
            data = {
                '__EVENTTARGET': 'ID_ucShowIHProjectList$UcNewsListPager1$UcPager1$btnPage2',
                ...
                'ID_ucShowIHProjectList$UcNewsListPager1$UcPager1$txtPage': p
            }
            browser = requests.post(self.url, data=urlencode(data))
